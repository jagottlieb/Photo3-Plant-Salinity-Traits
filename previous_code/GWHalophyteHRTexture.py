...
class SoilGW(object):
	...
	def __init__(self, stype, dynamics, zr, s, b, kmax, psissat):
		self.PSI_SS = psissat
		self.B = b
		self.KS = kmax
		self.N = stype.N
...
class SaltySoilGW(SoilGW):
	...
	def __init__(self, stype, dynamics, zr, s, b, kmax, psissat, cs, cgw, gw_z): #gw_z = depth to wt, gw_cs = salt concentration in gw, S_y = specific yield
		SoilGW.__init__(self, stype, dynamics, zr, s, b, kmax, psissat)
		self.s = s
